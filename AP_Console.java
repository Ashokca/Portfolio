...
public class AP_Console
{
  ...
  public static void main()
  {
    ...
    while (running) 
    {
        ...
        System.out.println("|      4. Loops            |" + menuMsg[4]);
        System.out.println("|                          |"+ menuTotalMsg);
        System.out.println("============================");

        swValue = Keyinput.inInt("Select"); 
        System.out.println();
        ...
        switch (swValue) 
        {
            ...
            case 2:
              ...
              break;
            case 3:
              menuMsg[3] = ForLoopQuestion.maintest();
              menuTotalMsg = Scoring.getCounterTotalMsg();
              break;
            case 4:
            	menuMsg[4] = IteratorQuestions.mainTest();
            	menuTotalMsg = Scoring.getCounterTotalMsg();
            	break;
              
          case 5:
                menuMsg[5] = ArrayQuestions.mainTest();
                menuTotalMsg = Scoring.getCounterTotalMsg();
                break;
